...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-onyx-model-sample-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-onyx-model-sample-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-onyx-model-sample-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-onyx_model_sample_dock-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
