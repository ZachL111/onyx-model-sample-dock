"""Regression checks for the onyx-model-sample-dock casebook."""
...
from casebook.harness import assert_expected, onyx_model_sample_dock_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(onyx_model_sample_dock_summary(), assert_expected())
